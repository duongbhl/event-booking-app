...
export default function AdminMessages() {
    ...
    ({ item }: { item: any }) => {
      ...
      return (
        ...
        >
          <Image
            source={{
              uri: item.avatar || "https://via.placeholder.com/48",
            }}
  ...
  const renderEmpty = useCallback(() => {
    ...
    return (
      <View className="items-center justify-center py-12 px-6">
        <Ionicons
          name={isShowingSearch ? "search-outline" : "chatbubble-ellipses-outline"}
          size={isSmallDevice ? 42 : 48}
          color="#D1D5DB"
        />
  ...
  }, [loading, isSearching, isShowingSearch, isSmallDevice]);
        ...
        >
          <View className="flex-row items-center justify-between mb-4">
            ...
            >
              <Ionicons
                name="chevron-back"
                size={isTablet ? 30 : isSmallDevice ? 24 : 26}
                color="#111"
              />
            </TouchableOpacity>
